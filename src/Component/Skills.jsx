...
const skills = [
    ...
    { name: "AI code Development", level: 85, category: "tools" },
                                ...
                                <div key={key} className='bg-card p-6 rounded-xl shadow-2xl cart-hover m-4'>
                                    ...
                                    <div className='w-full bg-secondary/30 h-2 rounded-full overflow-hidden'>
                                        <div
                                            ...
                                            style={{
                                                width: skill.category === "tools"
                                                    ? "100%"
                                                    : `${skill.level}%` // Directly use template literal here for the value
                                            }}
                                        >
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-right mt-1">
                                        <span className="text-sm text-muted-foreground">
                                            {
                                                skill.category == "tools" ? ""   : skill.level + "%"
                                            }
                                        </span>
                                    </div>
                                </div>
